//http://www.gov.china001.com/index.php?xname=FEE2511
var City=  {
	all:[
	{	
		"n":"北京市","pn":100000,
		"c":["东城区","西城区","崇文区","宣武区","朝阳区","丰台区","石景山区","海淀区","门头沟区","房山区","通州区","顺义区","昌平区","大兴区","怀柔区","平谷区","密云县","延庆县"],
		"p":[100010	 ,100032  ,100061  ,100053  ,100020  ,100071  ,100043    ,100080  ,102300    ,102400  ,101149  ,101300  ,102200  ,102600  ,101400  ,101200  ,101500  ,101300]
	},
	{
		"n":"上海市","pn":100000,
		"c":["黄浦区","卢湾区","徐汇区","长宁区","静安区","普陀区","闸北区","虹口区","杨浦区","闵行区","宝山区","嘉定区","浦东新区","金山区","松江区","青浦区","南汇区","奉贤区","崇明县"],
		"p":[200082  ,200020  ,200030  ,200050  ,200040  ,200063  ,200070  ,200080  ,  200093,200240  ,201900  ,201800  , 200120   ,201500  ,201600  ,201700  ,201300  ,201400  ,202150]
	},
	{
		"n":"天津市","pn":300000,
		"c":["和平区","河东区","河西区","南开区","河北区","红桥区","塘沽区","汉沽区","大港区","东丽区","西青区","津南区","北辰区","武清区","宝坻区","宁河县","静海县","蓟县"],
		"p":[300020  ,300171  ,300202  ,300100  ,300100  ,300131  ,300450  ,300480  ,300270  ,300300  ,300380  ,300350  ,300400  ,301700  ,301800  ,301500  ,301600  ,301900]
	},
	{
		"n":"重庆市",
		"c":["万州区","涪陵区","渝中区","大渡口区","江北区","沙坪坝区","九龙坡区","南岸区","北碚区","万盛区","双桥区","渝北区","巴南区","黔江区","长寿区","綦江县","潼南县","铜梁县","大足县","荣昌县","璧山县","梁平县","城口县","丰都县","垫江县","武隆县","忠县","开县","云阳县","奉节县","巫山县","巫溪县","石柱土家族自治县","秀山土家族苗族自治县","酉阳土家族苗族自治县","彭水苗族土家族自治县","江津市","合川市","永川市","南川市"],
		"p":[404000  ,408000  ,400010  ,400084    ,400020  ,400030    ,400050    ,400060  ,400700  ,400800  ,400900  ,401120  ,"401320",409000  ,401220  ,401420  ,402660  ,402560  ,402360  ,402460  ,402760  ,405200  ,405900  ,486200  ,408300  ,408500  ,404300,405400,404500  ,404600  ,404700  ,405800  ,409100,           ,409900                ,409800                ,409600                ,402260  ,401520  ,402160  ,408400]
	},
	{
		"n":"河北省",
		"c":["石家庄市","唐山市","秦皇岛市","邯郸市","邢台市","保定市","张家口市","承德市","沧州市","廊坊市","衡水市"],
		"p":["050011"  ,"063000","066000"  ,"056000","054000","071051","075000"  ,"067000","061001","065000","053000"]
	},
	...
	{"n":"新疆维吾尔自治区","c":["乌鲁木齐市","克拉玛依市","吐鲁番地区","哈密地区","昌吉回族自治州","博尔塔拉蒙古自治州","巴音郭楞蒙古自治州","阿克苏地区","克孜勒苏柯尔克孜自治州","喀什地区","和田地区","伊犁哈萨克自治州","塔城地区","阿勒泰地区","石河子市","阿拉尔市","图木舒克市","五家渠市"]},
	...
	getZipCode:function(privince,city){
		var r=[];
		for(var i=0, len=this.all.length; i<len; i++){
			if(this.all[i].n == privince){
				for(var j=0,len2 = this.all[i].c.length;j<len2;j++){
					if(this.all[i].c[j]==city){
						return this.all[i].p[j];
					}
				}
				return "";
			}
