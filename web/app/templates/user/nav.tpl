...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="205" valign="top" bgcolor="#FFFFFF"><a href="/"><img src="/assets/img/logo_3.gif" width="205" height="95" /></a></td>
    <td width="359" valign="top" background="/assets/img/head_bg.gif" bgcolor="#FFFFFF">&nbsp;</td>
    <td width="396" align="right" valign="top" bgcolor="#FFFFFF"><img src="/assets/img/head_1.gif" width="396" height="95" /></td>
  </tr>
</table>
<table id="nav" width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#FFFFFF"><table width="753" height="41" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td><a href="#"><img src_over='/assets/img/botton_dh_in_06.gif' src_out='/assets/img/botton_dh_off_06.gif' src="/assets/img/botton_dh_off_06.gif" width="131" height="41" border="0" /></a></td>
      </tr>
    </table>
      <table width="753" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><img src="/assets/img/dh_shadow.gif" width="753" height="8" /></td>
        </tr>
      </table></td>
  </tr>
</table>
